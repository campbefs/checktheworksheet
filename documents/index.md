...
Neither document below has been submitted, posted, or sent to anyone as of this writing. This
page will be updated with the date once that changes.
...
<ul class="doc-list">
  ...
  <li class="doc-item">
    ...
    <span class="doc-context">Eighteen pages, seventeen figures (E01–E17), each with the custody
      ...
      planned letter to a child-support-guidelines researcher, not for the Trial Court package,
      which is frozen at the version above. Every figure here also appears at
      <a href="/exhibits/">/exhibits/</a> as a web image with its underlying CSV linked beside it.
...
what was sent; the web pages are how to check it.

<div class="ask">
  <h2>Check it yourself</h2>
  <p>Every number in either document is reproducible from the model and data linked throughout
  this site.</p>
  <ul>
