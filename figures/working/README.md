...
| `fig11_deferral_timeline` | How many Massachusetts guidelines reviews have taken up the gross-versus-net income question: 5 of 7 documented cycles, 2002 to 2025 (2009, 2013, 2017, 2021 and 2025 deferred on the record; 2002 and 2006 marked no record, never inferred) | `fig11_deferral_timeline.py`; `data/deferrals-gross-vs-net.json` |

**Exhibit set (one chart per file, `E01`–`E27`, 23 files, no exhibit with more than one set of axes): `output/charts/exhibits/`, built by `exhibits.py` from the CSVs above and copies of the single-panel figures; naming and ratings in `docs/2026-09-05-chart-exhibit-guide.md`.** Measured on the 3-child Box 1 grid (1,147 cells), withholding basis, no refundable tax credits counted: recipient household ahead in 10% (75% below $150k higher-earner income, none above $175k); payor ahead per person in 99%; order above 40% of payor net in 15%, all at lower-earner income of $25k or less.
