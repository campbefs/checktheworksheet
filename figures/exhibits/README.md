...
**Retired from the exhibit set (multi-panel; kept as working figures for the paper only):** `fig1_headline_household_gap.png` (was E03; its three panels are now E18/E19/E01), `fig2_childcare_rules.png` (was E07; now E20/E21/E22), `fig7_box3_inversion.png` (was E14; now E23/E24), `fig8_both_pay.png` (was E15; now E25/E26). The old E03/E07/E14/E15 exhibit PNGs stay at their original filenames in this folder — already-sent documents cite those URLs, so the files are not moved or renamed — but no page on the site links or embeds them; nothing globbing this folder for the live set should match on the `E03`/`E07`/`E14`/`E15` prefixes.
