...
<figure class="exhibit" id="e16">
  ...
  <figcaption>
    ...
    <p class="exhibit-notes">Ten jurisdictions use a percentage-of-obligor, Melson, or open formula with no combined ceiling. Net-income ceilings are not dollar-for-dollar comparable with gross ones.</p>
...
<table class="exhibit-table">
  ...
  <thead>
    <tr><th scope="col">Jurisdiction</th><th scope="col">Formula type</th></tr>
  </thead>
  <tbody>
    <tr><td>Alaska</td><td>obligor cap, not combined income</td></tr>
    <tr><td>California</td><td>no stated ceiling</td></tr>
    <tr><td>Delaware</td><td>no stated ceiling</td></tr>
    <tr><td>Hawaii</td><td>no stated ceiling</td></tr>
    <tr><td>Mississippi</td><td>obligor cap, not combined income</td></tr>
    <tr><td>Montana</td><td>no stated ceiling</td></tr>
    <tr><td>Nevada</td><td>obligor cap, not combined income</td></tr>
    <tr><td>North Dakota</td><td>obligor cap, not combined income</td></tr>
    <tr><td>Texas</td><td>obligor cap, not combined income</td></tr>
