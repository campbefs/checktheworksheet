...
- **Measure the hardship test on the same income basis the order is paid from.** Line 7e reads 33
  percent of gross-derived income while the same dollars are 47 to 58 percent of the payor's net,
  depending on child care. No dollar amount changes; only what the form reports changes.
- **Allocate child care on the income split the order has already produced, not the split before
  ...
  percent and the order from $1,276 to $1,206 a week. Part two below carries this further.
- **Apply the equal-parenting credit once, at the transfer, instead of clipping it as an entitlement.**
  Variant A takes the equal-time order from $1,012.73 to $935.06 a week, a 7.7 percent cut, and
  raises the credit for equal time from 6.9 percent to 14.0 percent.

Nothing in this section changes the Worksheet's underlying schedule, its tranches, or its $430 per
child child-care ceiling. Every figure is reproduced in the model files linked at the bottom of this
page.
...
### Joint custody should be discounted by a cross-credit, not clipped by an income-share gap
...
duplication factor puts it at $701.30 a week, a 30.8 percent cut. That is $3,039 a month, which
...
three, a 50 percent discount at half the time. That rule gives $543.95 a week, or $2,357 a month,
16.4 percent below Washington and 2.8 percent below California. It is not the recommendation,
because it prices Massachusetts below both comparison states rather than in line with them.

For scale, matching the fifty-jurisdiction median exactly would take a 50.5 percent cut to today's
order, down to $511.27 a week.

| Rule | Weekly order | Monthly | Against the median | Against WA | Against CA |
|---|---|---|---|---|---|
| Today's Box 1 order | $1,012.73 | $4,388 | +102.0% | +55.6% | +81.0% |
| Variant A: 6e limitation moved to the transfer | $935.06 | $4,052 | +86.5% | +43.7% | +67.1% |
| **Cross-credit at duplication 1.5 (recommended)** | **$701.30** | **$3,039** | **+39.9%** | **+7.8%** | **+25.4%** |
| Linear discount at 50% of overnights | $543.95 | $2,357 | +8.5% | -16.4% | -2.8% |
| Exact fifty-state median | $511.27 | $2,173 | 0% | -22.9% | -10.4% |

"Against the median / WA / CA" states how far the candidate's monthly figure sits above or below
the fifty-jurisdiction median, Washington's equal-time order, and California's equal-time order.
...
### Child care should be split on the income mix the order has already created, not the mix before it

Child care is allocated on the 87.7 percent income split that the order itself has already changed
to 64.3 percent of gross and 48.2 percent of net.
...
and the order falls from $1,276.08 to $1,206.08 a week. The fuller version uses post-transfer net
...
| **Post-transfer gross shares (Line 6b-1, recommended now)** | **$1,206.08** | **64.5%** | **$10,054** |
